/*
  # Add company document tracking and verification

  This migration adds support for tracking various company documents, insurance status,
  claims history, and quality metrics.

  1. New Columns
    - insurance_documents: Track RC Pro and decennale insurance details
    - claims: Track claim history and current year claims
    - insee_verification: Store INSEE verification data
    - administrative_documents: Track administrative document status
    - quality_tracking: Store quality metrics and certifications
    - alerts: Track document expiration alerts
    - reminders: Store reminder notifications

  2. Indexes
    - Added GIN indexes for efficient JSON searching
    - Optimized for document expiration checks

  3. Triggers
    - Added document expiration checking trigger
    - Automatically creates alerts for expired documents

  4. Security
    - Added policies for commercial and mandatary access
*/
