/*
  # Création des tables utilisateurs et clients

  1. Tables
    - `users`: Stockage des informations utilisateur
    - `clients`: Stockage des informations client avec référence à users
  ...
  3. Indexation
    - Index sur email et rôle pour users
    - Index sur user_id et created_at pour clients
*/
